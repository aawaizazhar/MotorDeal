...
const VehicleCard = ({ vehicle }) => {
  ...
  const [imgSrc, setImgSrc] = useState(images[0] || fallbackImage);
    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden group">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link 
            to={`/vehicle/${id}`}
            className="bg-[#E11D48] hover:bg-[#CB1A41] text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center group"
          >
            <span>Details</span>
