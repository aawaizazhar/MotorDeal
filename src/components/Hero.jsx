    ...
    <div className="relative bg-car-blue-900 text-white min-h-[100vh] pt-5">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10 flex items-center min-h-[80vh] py-10 sm:py-0">
        <div className="w-full max-w-4xl mx-auto text-center">
          ...
          >
            <Button 
              className="bg-[#E11D48] backdrop-blur-md hover:bg-[#CB1A41] text-white font-semibold px-6 py-3 rounded-full text-base sm:text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center border border-[#E11D48]/30"
