        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-bold mb-6">
              Ready to Find Your <span className="text-car-red-500">Perfect Car?</span>
            </h3>
            ...
            <Button className="bg-car-red-500 hover:bg-car-red-600 text-white px-8 py-6 rounded-lg font-medium w-full md:w-auto transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg">
              Get Started Now
            </Button>
