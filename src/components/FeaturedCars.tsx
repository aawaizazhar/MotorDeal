    ...
    <div className="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
                  ...
                  <Link to={`/vehicles/${car.id}`} className="block">
                    ...
                    <div className="p-4 bg-white">
                      ...
                      <Link to={`/vehicles/${car.id}`}>
                        <Button className="w-full bg-car-red-500 hover:bg-car-red-600 text-white rounded-lg py-6 flex items-center justify-center group">
        ...
        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-8">
          {featuredCars.map((car, index) => (
            <Link to={`/vehicles/${car.id}`} className="block h-full">
              <motion.div
                key={car.id}
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <Link to={`/vehicles/${car.id}`} className="bg-white/90 hover:bg-white text-gray-900 px-4 py-2 rounded-lg font-medium transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    Quick View
                  </Link>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to={`/vehicles/${car.id}`}>
                    <Button className="bg-car-red-500 hover:bg-car-red-600 text-white rounded-lg px-4 py-2 flex items-center group">
                      <span>Details</span>
                      <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
                    </Button>
                  </Link>
        ...
        <div className="mt-12 text-center">
          <Link to="/vehicles">
            <Button variant="outline" className="border-2 border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white rounded-lg px-8 py-6 font-medium transition-colors duration-300 inline-flex items-center group">
