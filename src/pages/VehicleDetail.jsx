...
import { getVehicleById, getFilteredVehicles } from "@/data/vehicles";
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-8">
                <div className="rounded-lg overflow-hidden bg-gray-100 h-96 mb-2 flex items-center justify-center">
                  {vehicle?.images?.length > 0 && vehicle.images[activeImageIndex] ? (
                    <img
                          ...
                          <img
                            ...
                            onError={(e) => {
                              if (e.target instanceof HTMLImageElement) {
                                e.target.src = '/images/vehicles/fallback.jpg';
                              }
                            }}
                          />
                        </div>
