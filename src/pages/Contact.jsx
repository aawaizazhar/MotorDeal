...
const contactInfo = [
  {
    icon: <MapPin className="w-6 h-6" style={{ color: '#E11D48' }} />,
    title: "Visit Us",
    content: "123 Aziz Bhatti Road, Sialkot, Punjab, Pakistan"
  },
  {
    icon: <Phone className="w-6 h-6" style={{ color: '#E11D48' }} />,
    title: "Call Us",
    content: "+1 (555) 123-4567"
  },
  {
    icon: <Mail className="w-6 h-6" style={{ color: '#E11D48' }} />,
    title: "Email Us",
    content: "info@motordeal@gmail.com"
  },
  {
    icon: <Clock className="w-6 h-6" style={{ color: '#E11D48' }} />,
    title: "Working Hours",
...
const socialLinks = [
  { icon: <Facebook className="w-5 h-5" style={{ color: '#E11D48' }} />, url: "#", name: "Facebook" },
  { icon: <Twitter className="w-5 h-5" style={{ color: '#E11D48' }} />, url: "#", name: "Twitter" },
  { icon: <Instagram className="w-5 h-5" style={{ color: '#E11D48' }} />, url: "#", name: "Instagram" },
  { icon: <Linkedin className="w-5 h-5" style={{ color: '#E11D48' }} />, url: "#", name: "LinkedIn" }
];
      ...
      <div className="relative bg-gradient-to-r from-gray-900 to-black min-h-[70vh] sm:min-h-[80vh] md:h-96 flex items-center justify-center overflow-hidden py-16 sm:py-0">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 w-full max-w-4xl">
          <motion.div
            ...
            className="inline-block text-white px-3 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 border-2 shadow-md" style={{ backgroundColor: '#E11D48', borderColor: '#E11D48' }}
          >
              ...
              <div className="text-center mb-12">
                <motion.div 
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold mb-6 relative inline-block">
                    ...
                    <span className="absolute -bottom-3 left-0 w-full h-1 rounded-full" style={{ backgroundColor: '#E11D48' }}></span>
                  </h2>
                </motion.div>
