            ...
            >
              <div className="flex flex-col md:flex-row min-h-[350px]">
                ...
                <div className="md:w-1/2 p-10 md:p-16 flex flex-col justify-center z-10">
                  <h3 className="font-medium mb-3 uppercase" style={{ color: '#E11D48' }}>OUR STORY</h3>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-12 gap-4 max-w-6xl mx-auto">
              ...
              <motion.div 
                ...
                className="col-span-12 md:col-span-7 text-white rounded-lg p-8 text-center flex flex-col justify-center" style={{ backgroundColor: '#E11D48' }}
              >
              ...
              <motion.div 
                ...
                className="col-span-12 md:col-span-5 text-white rounded-lg p-8 text-center flex flex-col justify-center" style={{ backgroundColor: '#E11D48' }}
              >
